...
// Real files render as a transparent textarea overlaid on the highlighted
// lines — same JetBrains Mono metrics, so the caret tracks the painted code.
